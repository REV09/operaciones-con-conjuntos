...
Este es un ejemplo complejo pues los conjuntos no son del mismo tamaño
ademas de que son conjuntos un poco largos 
*/

//declaracion de los conjuntos sobre los que se van a trabajar
List<int> conjunto1 = [1, 3, 5, 7, 9, 11, 12, 13];
List<int> conjunto2 = [2, 4, 6, 8, 10, 11, 12, 14, 16, 18];
